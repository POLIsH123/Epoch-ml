            ...
            >
              <Box className="glass" p={6}>
                ...
                <VStack align="stretch" spacing={4}>
                  ...
                  <Textarea
                    value={`# ${models.find(m => m._id === formData.modelId)?.name} - ${models.find(m => m._id === formData.modelId)?.type} Model
                    ...
                    <Button
                      onClick={() => {
                        navigator.clipboard.writeText(
                          `# ${models.find(m => m._id === formData.modelId)?.name} - ${models.find(m => m._id === formData.modelId)?.type} Model
# Generated by Epoch-ML
