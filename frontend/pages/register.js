        ...
        >
          <VStack spacing={8}>
            ...
            <VStack spacing={2}>
              ...
              <Text color="gray.500" fontSize="lg">Establish New Architect Identity</Text>
            </VStack>
            ...
            <form onSubmit={handleSubmit} style={{ width: '100%' }}>
              <VStack spacing={5}>
                ...
                <FormControl id="username" isRequired>
                  <FormLabel fontSize="xs" fontWeight="bold" color="teal.400" textTransform="uppercase">Neural Handle (Username)</FormLabel>
                  <Input
                    type="text"
                    value={username}
            ...
            <HStack spacing={1}>
              ...
              <Link color="teal.300" fontWeight="bold" onClick={() => router.push('/login')}>
                Authorize Access
              </Link>
            </HStack>
          </VStack>
